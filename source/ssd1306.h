...
#define SSD1306_CMD_BYTE_SEND_MULTIPLE_COMMANDS (0x80U)
#define SSD1306_CMD_BYTE_SEND_ONE_COMMAND       (0x00U)
#define SSD1306_CMD_BYTE_SEND_MULTIPLE_DATA		(0xC0U)
#define SSD1306_CMD_BYTE_SEND_ONE_DATA			(0x40U)
